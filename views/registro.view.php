  ...
  <div class="row justify-content-center align-items-center h-100">
    <div class="col col-sm-6 col-md-6 col-lg-4 col-xl-3">
      <form method="post">
          ...
          <input type="text" id="usuario" name="usuario" class="form-control text-center mb-1" placeholder="Usuario" value=<?php if(isset($_SESSION['formularioRegistro'])){echo $_SESSION['formularioRegistro']['usuario'];}?>>
